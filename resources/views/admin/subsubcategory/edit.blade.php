...
<div class="row layout-spacing">
    ...
    <div class="col-lg-12 mt-4">
        <div class="statbox widget box box-shadow">
            ...
            <hr>
            <form action="{{route('subsubcategory.update',$subsubcategory->subsub_category_slug_en)}}" method="POST" >
            @csrf
                <div class="form-row mb-4">
                    <div class="col">
                        <label for="exampleFormControlInput1">Sub Subcategory Name English</label>
                      <input type="text" class="form-control" name="subsub_category_name_en" value="{{$subsubcategory->subsub_category_name_en}}"">
                    ...
                    <div class="col">
                      ...
                      <input type="text" class="form-control" name="subsub_category_name_bn" value="{{$subsubcategory->subsub_category_name_bn}}"">
...
@endforeach
    ...
    <option value="{{$subcategory->id}}" {{($subcategory->id==$subsubcategory->subcategory_id) ? 'selected': ''}} >{{$subcategory->sub_category_name_en}}</option>
                        @endforeach
