            ...
            <div class="user-profile layout-spacing mt-4">
                <div class="widget-content widget-content-area">
                    ...
                    <div class="text-center user-info mt-0 ">
                        ...
                        <img src="https://ui-avatars.com/api/?name={{$admin->name}}&color=7F9CF5&background=EBF4FF" width='80' class='rounded-full h-20 w-20 object-cover' alt="avatar">
                        @else
                        <img src="{{url('storage/profile-photos/'.$admin->profile_photo_path)}}" width='80' class='rounded-full h-20 w-20 object-cover' alt="avatar">
                        @endif
