            ...
            @csrf
                <div class="form-row mb-4">
                    <div class="col">
                      ...
                      <input type="text" class="form-control" name="post_title_en" placeholder=" ">
                      @error('post_title_en')
                    ...
                    <div class="col">
                      ...
                      <input type="text" class="form-control" name="post_title_bn" placeholder=" ">
                      @error('post_title_bn')
                      <span class="text-danger"> {{$message}} </span>
                  @enderror
                    </div>
...
@endforeach
                  ...
                  @enderror
                    ...
                    <div class="col">
                        <img class='mt-4 rounded-circle' id='showImg' src="https://ui-avatars.com/api/?name=Blog Name&color=7F9CF5&background=EBF4FF" width="50px" height="50px" alt="">
                ...
                <div class="form-row mb-4">
                    <div class="col">
                        ...
                        <textarea name="post_details_en"  value="{{old('post_details_en')}}"  class="form-control" id="" cols="20" rows="5"></textarea>
                    ...
                    <div class="col">
                        ...
                        <textarea name="post_details_bn"  value="{{old('post_details_bn')}}"  class="form-control" id="" cols="20" rows="10"></textarea>
