...
@yield('content')
    ...
    <script src="b{{asset('backend')}}/ootstrap/js/bootstrap.min.js"></script>
...
<!-- Mirrored from designreset.com/cork/ltr/demo3/auth_login_boxed.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Jun 2021 12:50:49 GMT -->
</html>
