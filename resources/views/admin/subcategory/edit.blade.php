...
<div class="row layout-spacing">
    ...
    <div class="col-lg-12 mt-4">
        <div class="statbox widget box box-shadow">
            ...
            <hr>
            <form action="{{route('subcategory.update',$subcategory->sub_category_slug_en)}}" method="POST" >
            @csrf
                <div class="form-row mb-4">
                    <div class="col">
                        <label for="exampleFormControlInput1">subcategory Name English</label>
                      <input type="text" class="form-control" value="{{$subcategory->sub_category_name_en}}" name="sub_category_name_en" placeholder=" ">
                    ...
                    <div class="col">
                      ...
                      <input type="text" class="form-control" value="{{$subcategory->sub_category_name_bn}}" name="sub_category_name_bn" placeholder=" ">
