            ...
            @csrf
                ...
                <div class="form-row mb-4">
                    ...
                    <div class="col">
                        ...
                        <textarea name="description" value="{{old('description')}}" class="form-control" id="" cols="10" rows="10"></textarea>
                ...
                <div class="form-row mb-4">
                  ...
                  @enderror
                    ...
                    <div class="col">
                        <img class='mt-4 rounded-circle' id='showImg' src="https://ui-avatars.com/api/?name=Slider Name&color=7F9CF5&background=EBF4FF" width="50px" height="50px" alt="">
