<header class="header-style-1">
            ...
            <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
              <div class="nav-outer">
                <ul class="nav navbar-nav">
                  <li class="active dropdown yamm-fw"> <a href="{{url('/')}}" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">Homes</a> </li>

                  {{-- categories Data--}}
    @php
        $categories = App\Models\categories::orderBy('category_name_en','ASC')->limit(6)->get();
    @endphp
    ...
    @foreach ($categories as $category)
                 ...
                 <li class="dropdown mega-menu">
                  ...
                  {{-- Subcategories Data--}}
                            ...
                            @php
                            $Subcategories = App\Models\Subcategories::where('category_id', $category->id)->orderBy('sub_category_name_en','ASC')->get();
                        @endphp
                  {{-- Subcategories Loop--}}
 ...
 @foreach ($Subcategories as $subcategory)
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-2 col-menu">
                              <h2 class="title">
                                @if(session()->get('language') == 'bangla')
                                {{$subcategory->sub_category_name_bn}}
                                @else
...
<ul class="links">
                                ...
                                <li><a href="#">
                                    @if(session()->get('language') == 'bangla')
                                    {{$subsubcategory->subsub_category_name_bn}}
                                    @else
                                     {{$subsubcategory->subsub_category_name_en}}
                                     @endif
                                </a></li>
                            </ul>
                            @endforeach
